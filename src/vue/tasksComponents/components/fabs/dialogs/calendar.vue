...
export default {
  ...
  methods: {
    getEvents(nodeId, taskId, state, begin, end) {
      return spinalTaskService.getEvents(nodeId, taskId, state, begin, end);
    },

    onEventClick(eventSelected, event) {
      event.stopPropagation();
      spinalPanelManagerService.openPanel("EventDetail", eventSelected);
    }
  }
};
</script>
