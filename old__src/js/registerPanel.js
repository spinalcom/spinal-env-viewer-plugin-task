...
import TaskConfigurationPanel from "../vue/configurationPanel/configurationPanel.vue";
...
import CreateVisitContextDialog from "../vue/panelComponent/dialogs/createVisteContext.vue"
...
let panels = [{
  ...
  vueMountComponent: vue.extend(TaskConfigurationPanel),
  panel: {
    title: "Task Configuration Panel",
    closeBehaviour: "hide"
  },
  style: {
    left: "400px"
...
const dialogs = [{
  ...
  },
  {
    ...
    name: "createVisitContextDialog",
    vueMountComponent: vue.extend(CreateVisitContextDialog),
    parentContainer: document.body
  }
];
